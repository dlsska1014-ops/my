...
eq(group.response.headers.get("x-accountbook-version"), "V22.8.46-MEMBER-ROLE-SCHEMA-ALIGNMENT", "runtime header reports V22.8.46 member role schema alignment");
