...
eq(group.response.headers.get("x-accountbook-version"), "V22.8.50-UIUX-STAGE4-QUICK-DOCK-SAVE-FEEDBACK", "runtime header reports V22.8.46 member role schema alignment");
