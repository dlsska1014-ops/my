...
eq(group.response.headers.get("x-accountbook-version"), "V22.8.51-INPUT-AMOUNT-RUNTIME-REGEX-FIX", "runtime header reports V22.8.46 member role schema alignment");
