...
eq(group.response.headers.get("x-accountbook-version"), "V22.8.52-SKILL-IP-GUARD-CSV-SAFE-NAME-FIX", "runtime header reports V22.8.46 member role schema alignment");
