...
eq(group.response.headers.get("x-accountbook-version"), "V22.8.80-RECURRING-MERGE-BUDGET-CLEANUP", "runtime header reports the challenge and activity UX release");
