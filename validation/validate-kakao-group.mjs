...
eq(group.response.headers.get("x-accountbook-version"), "V22.8.81-BUDGET-BASIS-INCOME-WORDING-IA", "runtime header reports the challenge and activity UX release");
