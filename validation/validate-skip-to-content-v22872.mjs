...
ok(source.includes('const APP_VERSION = "V22.8.73-CALENDAR-CHALLENGE-SECURITY"'), "runtime exposes the skip-to-content release");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22873.css"'), "the shell stylesheet moved to a new immutable address");
ok(source.includes('"accountbook-shell-v22873-css"'), "the shell stylesheet ships a matching ETag");
