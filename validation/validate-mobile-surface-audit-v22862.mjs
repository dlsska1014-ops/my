...
ok(source.includes('const APP_VERSION = "V22.8.98-RECEIPT-ORIGINALS"'), "runtime exposes the audit fix release");
...
try {
  ...
  for (const [name, path] of tabs) {
    ...
    const shellRefs = page.text.split('href="/assets/accountbook-shell-v22895.css"').length - 1;
