...
ok(source.includes('const APP_VERSION = "V22.8.89-QUICK-SHEET-TWO-TIER"'), "runtime exposes the audit fix release");
...
try {
  ...
  const shell = await request(fixture, "/assets/accountbook-shell-v22889.css", { cookie: "" });
  ...
  for (const [name, path] of tabs) {
    ...
    const shellRefs = page.text.split('href="/assets/accountbook-shell-v22889.css"').length - 1;
