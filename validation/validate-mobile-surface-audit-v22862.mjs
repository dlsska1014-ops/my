...
ok(source.includes('const APP_VERSION = "V22.8.91-HOME-REPORTS"'), "runtime exposes the audit fix release");
...
try {
  ...
  for (const [name, path] of tabs) {
    ...
    const shellRefs = page.text.split('href="/assets/accountbook-shell-v22891.css"').length - 1;
