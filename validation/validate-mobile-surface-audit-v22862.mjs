...
ok(source.includes('const APP_VERSION = "V22.8.88-HOME-BLOCKS-DAILY"'), "runtime exposes the audit fix release");
...
try {
  ...
  for (const [name, path] of tabs) {
    ...
    const shellRefs = page.text.split('href="/assets/accountbook-shell-v22888.css"').length - 1;
