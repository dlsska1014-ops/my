...
ok(source.includes('const APP_VERSION = "V22.8.98-RECEIPT-ORIGINALS"'), "runtime exposes the V22.8.83 release");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22895.css"'), "the shell stylesheet path is unchanged because its content is unchanged");
...
const shellRes = await get("/assets/accountbook-shell-v22895.css");
