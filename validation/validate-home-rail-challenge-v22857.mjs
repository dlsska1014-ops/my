...
ok(source.includes('const APP_VERSION = "V22.8.59-ACCOUNT-RUNTIME-RELIABILITY"'), "current runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22859.css"'), "changed shell uses a fresh immutable asset URL");
ok(source.includes('const ACCOUNTBOOK_V5_BUNDLE_JS_ASSET_PATH = "/assets/accountbook-v5-v22859.js"'), "changed V5 behavior uses a fresh immutable asset URL");
ok(source.includes('"accountbook-shell-v22859-css"'), "shell ETag is refreshed");
ok(source.includes('"accountbook-v5-v22859-js"'), "V5 bundle ETag is refreshed");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-shell-v22859.css'), "home loads the refreshed shell asset");
  ok(home.text.includes('/assets/accountbook-v5-v22859.js'), "home loads the refreshed V5 bundle");
  ...
  eq(v5.response.headers.get("etag"), '"accountbook-v5-v22859-js"', "refreshed V5 ETag is correct");
