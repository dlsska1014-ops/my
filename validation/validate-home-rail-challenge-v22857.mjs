...
ok(source.includes('const APP_VERSION = "V22.8.79-UIUX-INCOME-BUDGET-THEME"'), "current runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22879.css"'), "changed shell uses a fresh immutable asset URL");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-shell-v22879.css'), "home loads the refreshed shell asset");
