...
ok(source.includes('const APP_VERSION = "V22.8.60-FUNCTIONAL-UI-RELIABILITY"'), "current runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22860.css"'), "changed shell uses a fresh immutable asset URL");
ok(source.includes('const ACCOUNTBOOK_V5_BUNDLE_JS_ASSET_PATH = "/assets/accountbook-v5-v22860.js"'), "changed V5 behavior uses a fresh immutable asset URL");
ok(source.includes('"accountbook-shell-v22860-css"'), "shell ETag is refreshed");
ok(source.includes('"accountbook-v5-v22860-js"'), "V5 bundle ETag is refreshed");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-shell-v22860.css'), "home loads the refreshed shell asset");
  ok(home.text.includes('/assets/accountbook-v5-v22860.js'), "home loads the refreshed V5 bundle");
  ...
  eq(v5.response.headers.get("etag"), '"accountbook-v5-v22860-js"', "refreshed V5 ETag is correct");
