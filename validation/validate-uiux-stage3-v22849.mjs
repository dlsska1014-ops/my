...
ok(source.includes('const APP_VERSION = "V22.8.50-UIUX-STAGE4-QUICK-DOCK-SAVE-FEEDBACK"'), "stage 3 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22850.css"'), "stage 3 uses a fresh shell asset");
ok(source.includes('const ACCOUNTBOOK_V5_BUNDLE_JS_ASSET_PATH = "/assets/accountbook-v5-v22850.js"'), "stage 3 uses a fresh V5 runtime asset");
ok(source.includes('"accountbook-shell-v22850-css"'), "stage 3 shell has an immutable ETag");
ok(source.includes('"accountbook-v5-v22850-js"'), "stage 3 runtime has an immutable ETag");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-shell-v22850.css'), "home loads the stage 3 shell");
  ok(home.text.includes('/assets/accountbook-v5-v22850.js'), "home loads the stage 3 runtime");
  ...
  eq(v5.response.headers.get("etag"), '"accountbook-v5-v22850-js"', "stage 3 runtime ETag is correct");
  ...
  eq(shell.response.headers.get("etag"), '"accountbook-shell-v22850-css"', "stage 3 shell ETag is correct");
