...
ok(source.includes('const APP_VERSION = "V22.8.88-HOME-BLOCKS-DAILY"'), "stage 3 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22888-css"'), "current shell has an immutable ETag");
