...
ok(source.includes('const APP_VERSION = "V22.8.62-MOBILE-SURFACE-AUDIT-FIX"'), "stage 3 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22862-css"'), "current shell has an immutable ETag");
