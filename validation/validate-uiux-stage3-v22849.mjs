...
ok(source.includes('const APP_VERSION = "V22.8.67-ROLE-SURFACE-EMPTY-STATE"'), "stage 3 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22865.css"'), "current release uses a fresh shell asset");
ok(source.includes('const ACCOUNTBOOK_V5_BUNDLE_JS_ASSET_PATH = "/assets/accountbook-v5-v22861.js"'), "current release uses a fresh V5 runtime asset");
ok(source.includes('"accountbook-shell-v22865-css"'), "current shell has an immutable ETag");
ok(source.includes('"accountbook-v5-v22861-js"'), "current runtime has an immutable ETag");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-shell-v22865.css'), "home loads the current shell");
  ok(home.text.includes('/assets/accountbook-v5-v22861.js'), "home loads the current runtime");
  ...
  eq(v5.response.headers.get("etag"), '"accountbook-v5-v22861-js"', "current runtime ETag is correct");
  ...
  eq(shell.response.headers.get("etag"), '"accountbook-shell-v22865-css"', "current shell ETag is correct");
