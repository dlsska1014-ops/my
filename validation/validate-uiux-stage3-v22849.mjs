...
ok(source.includes('const APP_VERSION = "V22.8.79-UIUX-INCOME-BUDGET-THEME"'), "stage 3 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22879.css"'), "current release uses a fresh shell asset");
...
ok(source.includes('"accountbook-shell-v22879-css"'), "current shell has an immutable ETag");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-shell-v22879.css'), "home loads the current shell");
  ...
  eq(shell.response.headers.get("etag"), '"accountbook-shell-v22879-css"', "current shell ETag is correct");
