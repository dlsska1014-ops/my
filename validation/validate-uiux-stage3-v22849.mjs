...
ok(source.includes('const APP_VERSION = "V22.8.98-RECEIPT-ORIGINALS"'), "stage 3 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22895-css"'), "current shell has an immutable ETag");
