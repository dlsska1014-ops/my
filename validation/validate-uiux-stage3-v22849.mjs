...
ok(source.includes('const APP_VERSION = "V22.9.0-UX-REPAIR"'), "stage 3 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22912-css"'), "current shell has an immutable ETag");
