...
ok(source.includes('const APP_VERSION = "V22.8.86-DEFERRED-EDIT-FORMS"'), "stage 3 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22885-css"'), "current shell has an immutable ETag");
