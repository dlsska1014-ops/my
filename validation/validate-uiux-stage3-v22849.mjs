...
ok(source.includes('const APP_VERSION = "V22.8.100-DEAD-MARKUP"'), "stage 3 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22899-css"'), "current shell has an immutable ETag");
