...
ok(source.includes('const APP_VERSION = "V22.8.89-QUICK-SHEET-TWO-TIER"'), "stage 3 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22889-css"'), "current shell has an immutable ETag");
...
try {
  ...
  eq(v5.response.headers.get("etag"), '"accountbook-v5-v22873-js"', "current runtime ETag is correct");
