...
ok(source.includes('const APP_VERSION = "V22.8.61-MOBILE-SURFACE-REPAIR"'), "stage 3 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22861-css"'), "current shell has an immutable ETag");
