...
ok(source.includes('const APP_VERSION = "V22.8.82-TONE-TOKENS-ALERT-WINDOW"'), "runtime exposes the budget and dark contrast release");
...
try {
  ...
  const shell = await app.fetch(new Request(`${ORIGIN}/assets/accountbook-shell-v22882.css`), fixture.env, {});
