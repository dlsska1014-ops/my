...
ok(source.includes('const APP_VERSION = "V22.8.77-INTERRUPTED-SAVE-RECOVERY"'), "runtime exposes the budget and dark contrast release");
...
try {
  ...
  const shell = await app.fetch(new Request(`${ORIGIN}/assets/accountbook-shell-v22874.css`), fixture.env, {});
