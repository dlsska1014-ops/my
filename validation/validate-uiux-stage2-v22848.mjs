...
ok(source.includes('const APP_VERSION = "V22.8.98-RECEIPT-ORIGINALS"'), "stage 2 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22895.css"'), "current release uses a new shell asset");
