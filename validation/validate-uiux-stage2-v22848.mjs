...
ok(source.includes('const APP_VERSION = "V22.8.58-CHALLENGE-ACTIVITY-UX"'), "stage 2 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22858.css"'), "current release uses a new shell asset");
ok(source.includes('const ACCOUNTBOOK_V5_BUNDLE_JS_ASSET_PATH = "/assets/accountbook-v5-v22858.js"'), "current release uses a new V5 asset");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-v5-v22858.js'), "home loads the current V5 bundle");
  ...
  const asset = await request(fixture, "/assets/accountbook-v5-v22858.js");
