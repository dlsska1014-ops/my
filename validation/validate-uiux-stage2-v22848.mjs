...
ok(source.includes('const APP_VERSION = "V22.8.93-NUMBER-TRANSITIONS"'), "stage 2 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22891.css"'), "current release uses a new shell asset");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-v5-v22890.js'), "home loads the current V5 bundle");
  ...
  const asset = await request(fixture, "/assets/accountbook-v5-v22890.js");
