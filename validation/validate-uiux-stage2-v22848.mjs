...
ok(source.includes('const APP_VERSION = "V22.8.60-FUNCTIONAL-UI-RELIABILITY"'), "stage 2 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22860.css"'), "current release uses a new shell asset");
ok(source.includes('const ACCOUNTBOOK_V5_BUNDLE_JS_ASSET_PATH = "/assets/accountbook-v5-v22860.js"'), "current release uses a new V5 asset");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-v5-v22860.js'), "home loads the current V5 bundle");
  ...
  const asset = await request(fixture, "/assets/accountbook-v5-v22860.js");
