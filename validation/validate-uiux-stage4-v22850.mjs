...
ok(source.includes('const APP_VERSION = "V22.8.72-SKIP-TO-CONTENT"'), "stage 4 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22872-css"'), "current shell has a fresh immutable ETag");
