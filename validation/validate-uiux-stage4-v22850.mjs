...
ok(source.includes('const APP_VERSION = "V22.8.67-ROLE-SURFACE-EMPTY-STATE"'), "stage 4 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22865-css"'), "current shell has a fresh immutable ETag");
