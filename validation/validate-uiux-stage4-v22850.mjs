...
ok(source.includes('const APP_VERSION = "V22.8.77-INTERRUPTED-SAVE-RECOVERY"'), "stage 4 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22874-css"'), "current shell has a fresh immutable ETag");
