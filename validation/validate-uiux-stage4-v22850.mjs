...
ok(source.includes('const APP_VERSION = "V22.8.59-ACCOUNT-RUNTIME-RELIABILITY"'), "stage 4 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22859.css"'), "current release uses a fresh shell asset");
...
ok(source.includes('const ACCOUNTBOOK_V5_BUNDLE_JS_ASSET_PATH = "/assets/accountbook-v5-v22859.js"'), "current release uses a fresh V5 asset");
ok(source.includes('"accountbook-shell-v22859-css"'), "current shell has a fresh immutable ETag");
ok(source.includes('"accountbook-nav-v22850-js"'), "stage 4 navigation has a fresh immutable ETag");
ok(source.includes('"accountbook-v5-v22859-js"'), "current V5 runtime has a fresh immutable ETag");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-shell-v22859.css'), "home loads the current shell");
  ok(home.text.includes('/assets/accountbook-nav-v22850.js'), "home loads the stage 4 navigation runtime");
  ok(home.text.includes('/assets/accountbook-v5-v22859.js'), "home loads the current V5 runtime");
  ...
  eq(shell.response.headers.get("etag"), '"accountbook-shell-v22859-css"', "current shell ETag is correct");
  ...
  eq(v5.response.headers.get("etag"), '"accountbook-v5-v22859-js"', "current V5 runtime ETag is correct");
