...
ok(source.includes('const APP_VERSION = "V22.8.79-UIUX-INCOME-BUDGET-THEME"'), "stage 4 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22879-css"'), "current shell has a fresh immutable ETag");
