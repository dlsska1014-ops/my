...
ok(source.includes('const APP_VERSION = "V22.8.68-TAP-TARGET-ACCESSIBILITY"'), "stage 4 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22868-css"'), "current shell has a fresh immutable ETag");
