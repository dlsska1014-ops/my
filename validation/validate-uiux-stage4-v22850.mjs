...
ok(source.includes('const APP_VERSION = "V22.8.73-CALENDAR-CHALLENGE-SECURITY"'), "stage 4 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22873-css"'), "current shell has a fresh immutable ETag");
