...
ok(source.includes('const APP_VERSION = "V22.8.81-BUDGET-BASIS-INCOME-WORDING-IA"'), "stage 4 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22880-css"'), "current shell has a fresh immutable ETag");
