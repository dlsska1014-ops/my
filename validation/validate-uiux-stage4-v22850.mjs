...
ok(source.includes('const APP_VERSION = "V22.8.92-SCREEN-CLEANUP"'), "stage 4 runtime version is explicit");
...
ok(source.includes('"accountbook-shell-v22891-css"'), "current shell has a fresh immutable ETag");
