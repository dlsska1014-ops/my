...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22910.css"'), "current release uses a fresh shell asset");
...
ok(source.includes('"accountbook-shell-v22910-css"'), "current shell has a fresh immutable ETag");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-shell-v22910.css'), "home loads the current shell");
  ...
  eq(shell.response.headers.get("etag"), '"accountbook-shell-v22910-css"', "current shell ETag is correct");
