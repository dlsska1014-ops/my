...
try {
  ...
  const cssPaths = ["/assets/mobile-home-v22810.css", "/assets/accountbook-shell-v22811.css", "/assets/accountbook-shell-v22861.css"];
  ...
  const stage4NavJs = await request("/assets/accountbook-nav-v22861.js");
  const stage4NavRuntime = await stage4NavJs.text();
  const stage4NavGetDatabaseCalls = calls.length;
  const stage4NavHead = await request("/assets/accountbook-nav-v22861.js", { method: "HEAD" });
  ...
  eq(stage4NavJs.headers.get("etag"), '"accountbook-nav-v22861-js"', "V5 navigation runtime has a versioned ETag");
  ...
  const shellCssResponse = await request("/assets/accountbook-shell-v22861.css");
  ...
  eq(countOf(householdsHtml, 'href="/assets/accountbook-shell-v22861.css"'), 1, "accountbook management loads the shell once");
  ...
  ok(householdsHtml.lastIndexOf('href="/assets/accountbook-shell-v22861.css"') > householdsHtml.lastIndexOf("</style>"), "accountbook shell is the final stylesheet cascade");

  const backup = await request("/my/backup-login?return_to=%2Fapp");
  const backupHtml = await backup.text();
  eq(countOf(backupHtml, 'href="/assets/accountbook-shell-v22861.css"'), 1, "account security loads the shell once");
  ...
  eq(countOf(loginHtml, 'href="/assets/accountbook-shell-v22861.css"'), 1, "login loads the shell once");
