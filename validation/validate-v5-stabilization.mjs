...
ok(source.includes('const APP_VERSION = "V22.8.69-KAKAO-MEMO-REPEAT-FIX"'), "runtime reports the challenge and activity UX release");
...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22868.css", "text/css"],
