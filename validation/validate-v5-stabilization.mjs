...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22844.css", "text/css"],
    ["/assets/accountbook-nav-v22836.js", "javascript"],
    ["/assets/accountbook-v5-v22838.js", "javascript"],
  ...
  ok(home.text.includes("accountbook-v5-v22838.js"), "V5 home loads the shared bundle");
  ok(home.text.includes("accountbook-nav-v22836.js"), "V5 home loads the shared navigation runtime");
