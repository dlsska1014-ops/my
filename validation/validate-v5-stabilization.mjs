...
ok(source.includes('const APP_VERSION = "V22.8.89-QUICK-SHEET-TWO-TIER"'), "runtime reports the challenge and activity UX release");
...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22889.css", "text/css"],
    ["/assets/accountbook-nav-v22889.js", "javascript"],
  ...
  ok(home.text.includes("accountbook-nav-v22889.js"), "V5 home loads the shared navigation runtime");
