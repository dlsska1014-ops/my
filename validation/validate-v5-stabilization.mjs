...
ok(source.includes('const APP_VERSION = "V22.8.67-ROLE-SURFACE-EMPTY-STATE"'), "runtime reports the challenge and activity UX release");
...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22865.css", "text/css"],
