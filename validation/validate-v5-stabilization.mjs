...
ok(source.includes('const APP_VERSION = "V22.8.60-FUNCTIONAL-UI-RELIABILITY"'), "runtime reports the challenge and activity UX release");
...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22860.css", "text/css"],
    ["/assets/accountbook-nav-v22860.js", "javascript"],
    ["/assets/accountbook-v5-v22860.js", "javascript"],
  ...
  ok(home.text.includes("accountbook-v5-v22860.js"), "V5 home loads the shared bundle");
  ok(home.text.includes("accountbook-nav-v22860.js"), "V5 home loads the shared navigation runtime");
