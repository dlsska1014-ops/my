...
ok(source.includes('const APP_VERSION = "V22.8.50-UIUX-STAGE4-QUICK-DOCK-SAVE-FEEDBACK"'), "runtime reports the V22.8.46 member role schema alignment release");
...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22850.css", "text/css"],
    ["/assets/accountbook-nav-v22850.js", "javascript"],
    ["/assets/accountbook-v5-v22850.js", "javascript"],
  ...
  ok(home.text.includes("accountbook-v5-v22850.js"), "V5 home loads the shared bundle");
