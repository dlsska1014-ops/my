...
ok(source.includes('const APP_VERSION = "V22.8.62-MOBILE-SURFACE-AUDIT-FIX"'), "runtime reports the challenge and activity UX release");
...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22862.css", "text/css"],
