...
ok(source.includes('const APP_VERSION = "V22.8.72-SKIP-TO-CONTENT"'), "runtime reports the challenge and activity UX release");
...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22872.css", "text/css"],
