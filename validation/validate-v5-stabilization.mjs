...
ok(source.includes('const APP_VERSION = "V22.8.84-RECEIPT-PARSE-ACCURACY"'), "runtime reports the challenge and activity UX release");
...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22882.css", "text/css"],
