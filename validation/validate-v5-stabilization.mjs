...
ok(source.includes('const APP_VERSION = "V22.8.61-MOBILE-SURFACE-REPAIR"'), "runtime reports the challenge and activity UX release");
...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22861.css", "text/css"],
    ["/assets/accountbook-nav-v22861.js", "javascript"],
    ["/assets/accountbook-v5-v22861.js", "javascript"],
  ...
  ok(home.text.includes("accountbook-v5-v22861.js"), "V5 home loads the shared bundle");
  ok(home.text.includes("accountbook-nav-v22861.js"), "V5 home loads the shared navigation runtime");
