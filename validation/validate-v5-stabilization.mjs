...
ok(source.includes('const APP_VERSION = "V22.8.88-HOME-BLOCKS-DAILY"'), "runtime reports the challenge and activity UX release");
...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22888.css", "text/css"],
    ["/assets/accountbook-nav-v22886.js", "javascript"],
  ...
  ok(home.text.includes("accountbook-nav-v22886.js"), "V5 home loads the shared navigation runtime");
