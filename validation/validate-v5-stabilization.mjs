...
ok(source.includes('const APP_VERSION = "V22.8.77-INTERRUPTED-SAVE-RECOVERY"'), "runtime reports the challenge and activity UX release");
...
try {
  ...
  for (const [path, mime] of [
    ["/assets/accountbook-shell-v22874.css", "text/css"],
