...
try {
  ...
  const shellResponse = await request("/assets/accountbook-shell-v22895.css");
  ...
  eq(countOf(calendarHomeHtml, 'href="/assets/accountbook-shell-v22895.css"'), 1, "home loads the current shell exactly once");
  ...
  ok(insightHtml.includes('/my/analysis/app.js?v=V22.8.98-RECEIPT-ORIGINALS'), "analysis keeps the protected external runtime with the new cache version");
  eq(countOf(insightHtml, 'href="/assets/accountbook-shell-v22895.css"'), 1, "analysis loads the current shell exactly once");
