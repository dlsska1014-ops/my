...
try {
  ...
  const shellResponse = await request("/assets/accountbook-shell-v22885.css");
  eq(shellResponse.status, 200, "V22.8.38 V5 stabilization stylesheet is served");
  eq(shellResponse.headers.get("etag"), '"accountbook-shell-v22885-css"', "current shell has a fresh immutable ETag");
