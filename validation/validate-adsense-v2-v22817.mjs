...
try {
  ...
  ok(insightHtml.includes('/my/analysis/app.js?v=V22.8.81-BUDGET-BASIS-INCOME-WORDING-IA'), "analysis keeps the protected external runtime with the new cache version");
