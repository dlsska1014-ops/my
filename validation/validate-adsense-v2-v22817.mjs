...
try {
  ...
  ok(insightHtml.includes('/my/analysis/app.js?v=V22.8.52-SKILL-IP-GUARD-CSV-SAFE-NAME-FIX'), "analysis keeps the protected external runtime with the new cache version");
