...
try {
  ...
  ok(insightHtml.includes('/my/analysis/app.js?v=V22.8.76-KAKAO-INTENT-SKILL-AUTH'), "analysis keeps the protected external runtime with the new cache version");
