...
try {
  ...
  ok(insightHtml.includes('/my/analysis/app.js?v=V22.8.53-BUDGET-RATE-DISPLAY-FIX'), "analysis keeps the protected external runtime with the new cache version");
