...
ok(source.includes('const APP_VERSION = "V22.8.60-FUNCTIONAL-UI-RELIABILITY"'), "stage 1 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22860.css"'), "current release uses a fresh immutable shell asset");
ok(source.includes('const ACCOUNTBOOK_V5_BUNDLE_JS_ASSET_PATH = "/assets/accountbook-v5-v22860.js"'), "current release uses a fresh immutable V5 bundle");
ok(source.includes('"accountbook-shell-v22860-css"'), "current shell has a distinct ETag");
