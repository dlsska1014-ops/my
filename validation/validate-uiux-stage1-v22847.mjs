...
ok(source.includes('const APP_VERSION = "V22.8.73-CALENDAR-CHALLENGE-SECURITY"'), "stage 1 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22873.css"'), "current release uses a fresh immutable shell asset");
...
ok(source.includes('"accountbook-shell-v22873-css"'), "current shell has a distinct ETag");
