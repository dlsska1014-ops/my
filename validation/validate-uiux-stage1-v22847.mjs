...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22913.css"'), "current release uses a fresh immutable shell asset");
...
ok(source.includes('"accountbook-shell-v22913-css"'), "current shell has a distinct ETag");
