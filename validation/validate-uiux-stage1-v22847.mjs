...
ok(source.includes('const APP_VERSION = "V22.8.50-UIUX-STAGE4-QUICK-DOCK-SAVE-FEEDBACK"'), "stage 1 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22850.css"'), "stage 1 uses a new immutable shell asset");
ok(source.includes('const ACCOUNTBOOK_V5_BUNDLE_JS_ASSET_PATH = "/assets/accountbook-v5-v22850.js"'), "sidebar runtime uses a new immutable V5 bundle");
ok(source.includes('"accountbook-shell-v22850-css"'), "stage 1 shell has a distinct ETag");
