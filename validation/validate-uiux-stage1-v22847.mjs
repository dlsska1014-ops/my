...
ok(/const APP_VERSION = "V\d+\.\d+\.\d+[-A-Z0-9]*"/.test(source), "stage 1 runtime version is explicit");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22914.css"'), "current release uses a fresh immutable shell asset");
...
ok(source.includes('"accountbook-shell-v22914-css"'), "current shell has a distinct ETag");
