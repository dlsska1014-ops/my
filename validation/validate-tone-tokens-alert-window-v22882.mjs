...
ok(source.includes('const APP_VERSION = "V22.8.98-RECEIPT-ORIGINALS"'), "runtime exposes the V22.8.82 release");
...
eq(shellRes.headers.get("etag"), '"accountbook-shell-v22895-css"', "the served ETag matches the path");
