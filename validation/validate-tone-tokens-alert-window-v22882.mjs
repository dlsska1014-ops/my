...
const shellRes = await get("/assets/accountbook-shell-v22911.css");
eq(shellRes.status, 200, "the bumped shell stylesheet is served");
eq(shellRes.headers.get("etag"), '"accountbook-shell-v22911-css"', "the served ETag matches the path");
