...
ok(source.includes('const APP_VERSION = "V22.9.0-UX-REPAIR"'), "runtime exposes the V22.8.82 release");
...
const shellRes = await get("/assets/accountbook-shell-v22910.css");
eq(shellRes.status, 200, "the bumped shell stylesheet is served");
eq(shellRes.headers.get("etag"), '"accountbook-shell-v22910-css"', "the served ETag matches the path");
