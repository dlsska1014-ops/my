...
ok(source.includes('const APP_VERSION = "V22.8.77-INTERRUPTED-SAVE-RECOVERY"'), "V22.8.58 runtime version is explicit");
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22874.css"'), "shell uses a fresh immutable URL");
...
try {
  ...
  ok(home.text.includes('/assets/accountbook-shell-v22874.css'), "home loads the refreshed shell");
