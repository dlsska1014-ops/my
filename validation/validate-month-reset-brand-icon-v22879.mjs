...
ok(source.includes('const APP_VERSION = "V22.8.79-UIUX-INCOME-BUDGET-THEME"'), "runtime exposes the month reset and brand icon release");
...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v22879.css"'), "the shell stylesheet path is bumped");
...
ok(source.includes('\'"accountbook-shell-v22879-css"\''), "the shell stylesheet ETag matches its path");
