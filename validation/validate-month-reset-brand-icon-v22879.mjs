...
ok(source.includes('const MOBILE_HOME_CSS_ASSET_PATH = "/assets/mobile-home-v22914.css"'), "the mobile home stylesheet path is bumped");
...
ok(source.includes("'\"mobile-home-v2290-css\"'") || source.includes('\'"mobile-home-v22914-css"\''), "the mobile home stylesheet ETag matches its path");
