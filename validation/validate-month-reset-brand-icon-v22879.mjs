...
ok(source.includes('const ACCOUNTBOOK_SHELL_CSS_ASSET_PATH = "/assets/accountbook-shell-v2299.css"'), "the shell stylesheet path is bumped");
...
ok(source.includes('\'"accountbook-shell-v2299-css"\''), "the shell stylesheet ETag matches its path");
