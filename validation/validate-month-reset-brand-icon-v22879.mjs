...
ok(source.includes('const APP_VERSION = "V22.8.89-QUICK-SHEET-TWO-TIER"'), "runtime exposes the month reset and brand icon release");
...
ok(source.includes('const MOBILE_HOME_CSS_ASSET_PATH = "/assets/mobile-home-v22889.css"'), "the mobile home stylesheet path is bumped");
...
ok(source.includes("'\"mobile-home-v22889-css\"'") || source.includes('\'"mobile-home-v22889-css"\''), "the mobile home stylesheet ETag matches its path");
