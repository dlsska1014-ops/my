...
ok(source.includes('const APP_VERSION = "V22.8.67-ROLE-SURFACE-EMPTY-STATE"'), "runtime exposes the mobile surface repair release");
...
try {
  ...
  const shell = await request(fixture, "/assets/accountbook-shell-v22865.css", { cookie: "" });
