...
if (chromiumExecutable) browserLaunchOptions.executablePath = chromiumExecutable;
if (chromiumModulePath) {
  const imported = await import(pathToFileURL(`${chromiumModulePath.replace(/\/$/, "")}/build/esm/index.js`).href);
...
const outputDir = process.argv[2] || "visual_qa_v2267";
