...
- [x] 사용자 화면에 V22.8.14 CSS와 테마 JavaScript를 정확히 한 번 연결
...
- [x] 영수증 55개, 카카오 18개, 보안 43개, UX 55개, 홈 버튼·테마·성능 120개
- [x] 총 291개 자동 검사와 ESM `default.fetch`
...
- [ ] `/health` 버전 확인
- [ ] V22.8.14 CSS와 V22.8.12 테마 JavaScript의 200·MIME·immutable·ETag
...
- [ ] 직전 V22.8.13 `src/index.js`로 전체 코드 롤백
- [ ] SQL·환경변수·외부 콘솔 롤백 없음
- [ ] 캐시 문제면 V22.8.13 CSS 자원 경로 복귀 확인
