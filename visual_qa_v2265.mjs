...
if (chromiumModulePath) {
  const imported = await import(pathToFileURL(`${chromiumModulePath.replace(/\/$/, "")}/build/index.js`).href);
...
const outputDir = process.argv[2] || "visual_qa_v2266";
...
const routes = [
  ...
  ["03_menu", "/menu?month=2026-07&household_id=house-home"],
  ["04_smart_tools", "/smart-tools?month=2026-07&household_id=house-home"],
  ["05_receipts", "/receipts?month=2026-07&household_id=house-home"],
  ["06_reports", "/reports?month=2026-07&household_id=house-home"],
  ["07_card_benefits", "/card-benefits?month=2026-07&household_id=house-home"],
  ["08_settlement_equal", "/settlement-summary?month=2026-07&household_id=house-home&mode=equal"],
  ["09_settlement_item", "/settlement-summary?month=2026-07&household_id=house-home&mode=item"],
  ["10_meme_lab", "/meme-lab?month=2026-07&household_id=house-home"],
  ["11_meme_archive", "/meme-archive?month=2026-07&household_id=house-home"],
