...
node validation/validate-member-role-schema-v22846.mjs
...
node validation/validate-v5-stabilization.mjs
node validation/validate-core-write-smoke.mjs

echo "V22.8.46 member role schema alignment validation complete: 902 checks passed"
