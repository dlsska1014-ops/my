...
try {
  ...
  eq(health.version, "V22.8.2-AUTH-UIUX-STABILIZATION", "health exposes current stabilization version");
  ...
  for (const label of ["스마트 분석", "정산", "자산·결제수단", "정기지출", "백업·복구"]) ok(body.includes(label), `menu keeps ${label}`);
