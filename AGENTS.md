...
- `src/index.js`는 저장소에서 직접 수정할 수 있지만 운영 배포는 항상 검증된
  파일 전체 교체 방식이다.
- 현재 V22.8.17은 신규 SQL, 스키마, 환경변수, Kakao Developers,
...
현재 배포 묶음 체크섬 32개, 영수증 55개, 카카오 그룹 18개, 가계부 보안 43개,
UX 55개, 사용자 화면·홈 버튼·테마·성능 134개, AdSense 심사·V2 화면 228개로 총 533개, ESM `default.fetch`, 작업 트리와
