...
현재 배포 묶음 체크섬, 영수증 56개, 카카오 그룹 22개, 카카오 수정·삭제·복구 130개, 가계부·운영 보안 75개,
참여자 역할 스키마 20개, UX 56개, 사용자 화면·홈 버튼·테마·성능 153개, AdSense 심사·V2 화면 261개, V5 안정화 41개, 핵심 쓰기 스모크 97개,
UI/UX 1~4단계 218개로 총 1129개, ESM `default.fetch`, 작업 트리와
