...
assert.match(src, /V22\.0-NLU-FOUNDATION-LOW-COST-BUNDLE/);
...
console.log(JSON.stringify({ok:true,version:"V22.0",alias_positive:aliasPos.length,negative:negative.length}));
