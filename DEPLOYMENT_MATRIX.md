...
|---|---:|---:|---:|---:|---:|---|
| V22.8.71 | 필요 | 없음 | 없음 | 없음 | 없음 | 날짜 수정이 다른 날 기록을 건드림·연속 삭제 후 복구 소실·수정에서 금액 표기 거절 수정 |
| V22.8.70 | 필요 | 없음 | 없음 | 없음 | 없음 | 12,345원→345원·3만5천원 두 건 분할·조사로 끝나는 낱말 잘림 수정 |
| V22.8.69 | 필요 | 없음 | 없음 | 없음 | 없음 | 카카오 한 줄 입력 메모 손상·중복 방지 오작동·또 낱말 분리 수정 |
| V22.8.68 | 필요 | 없음 | 없음 | 없음 | 없음 | 접기 헤더·카드 링크 탭 영역 44px 확보와 구조 접근성 회귀 고정 |
| V22.8.67 | 필요 | 없음 | 없음 | 없음 | 없음 | 분류·키워드 권한 막다른 길 제거·권한 문구 통일·빈 가계부 홈 문구 |
| V22.8.66 | 필요 | 없음 | 없음 | 없음 | 없음 | 웹 거래 삭제 동작 복구 |
| V22.8.65 | 필요 | 없음 | 없음 | 없음 | 없음 | 라이트·다크 8개 조합 글자 대비 보정 |
| V22.8.64 | 필요 | 없음 | 없음 | 없음 | 없음 | 웹 매니페스트·설치 아이콘 제공과 아이콘 압축 |
| V22.8.63 | 필요 | 없음 | 없음 | 없음 | 없음 | favicon·apple-touch-icon 제공으로 전 화면 404 제거 |
| V22.8.62 | 필요 | 없음 | 없음 | 없음 | 없음 | 전체 탭 점검 후 상단바 버튼 폭·최근 내역 필터 이탈·앵커 오프셋 보정 |
| V22.8.61 | 필요 | 없음 | 없음 | 없음 | 없음 | 모바일 상단바 작업 버튼·전체 메뉴 터치 영역·입력 아이콘·빠른입력 스크롤/아이콘·날짜 입력 이탈 |
| V22.8.60 | 필요 | 없음 | 없음 | 없음 | 없음 | 챌린지 인라인 저장·메뉴 활성·모바일 조작 영역·HEAD·스킬 본문 상한 |
| V22.8.59 | 필요 | 없음 | 없음 | 없음 | 없음 | 계정 생성 오류 분류·세션 실패 폐쇄·최근 기록 제한·대량 분석 경고 |
| V22.8.58 | 필요 | 없음 | 없음 | 없음 | 없음 | 7일 이하 날짜형 챌린지·8일 이상 퍼센트·최근 기록 SVG/정보 위계 개선 |
| V22.8.57 | 필요 | 없음 | 없음 | 없음 | 없음 | 리포트 월 탐색·중앙 대시보드·홈 우측 기록·챌린지 날짜/진행 계산 보정 |
| V22.8.56 | 불필요(문서·검증만) | 없음 | 없음 | 없음 | 없음 | 홈 HTML 예산을 측정 조건별 35KB/44KB로 개정 |
...
- 기존 SQL: `/ready`가 정상이면 다시 실행하지 않음
- 환경변수·Secret·Kakao Developers·OpenBuilder: 변경 없음
- 적용 후 `/health`, `/ready`, 세 신규 immutable 자산, 공개 `HEAD`, 챌린지 `7일 → 8일` 인라인 저장 확인
