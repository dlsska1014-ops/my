...
|---|---:|---:|---:|---:|---:|---|
| V22.8.78 | 필요 | 없음 | 없음 | 없음 | 없음 | 적다가 새로고침해도 내용 보존, 11단계 완료 |
| V22.8.77 | 필요 | 없음 | 없음 | 없음 | 없음 | 로그인 만료 시 복구 흐름, 쓰던 화면 복귀 |
| V22.8.76 | 필요 | 없음 | **선택 1개** | **헤더 설정** | 없음 | 되묻기 정리, 예산 명령 결함 2건, /skill 인증 관측·observe 모드 |
| V22.8.75 | 필요 | 없음 | 없음 | 없음 | 없음 | 통계·종합 리포트 중복 카드 정리, 보조 버튼 명시도 보정 |
| V22.8.74 | 필요 | 없음 | 없음 | 없음 | 없음 | 예산 검사 교정·재설정, 다크 빈 상태·본문 바로가기 대비 보정 |
| V22.8.73 | 필요 | **있음** | 선택 3개 | 선택 | 선택 | 캘린더·챌린지·보안 병합, 가계부 삭제 완전성 SQL, 선택적 /skill 인증 |
| V22.8.72 | 필요 | 없음 | 없음 | 없음 | 없음 | 본문 건너뛰기 수단 부재(Tab 55회) 수정, 포커스 표시 전수 확인 |
